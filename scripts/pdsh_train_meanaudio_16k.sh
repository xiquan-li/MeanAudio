...
EXP_ID=AW_7kh_bsz${BATCH_SIZE}_numgpus${TOTAL_GPUS}_niter${NUM_ITERATIONS}_T5_CLAP_${MODEL}
# EXP_ID=AC_10s_bsz${BATCH_SIZE}_numgpus${TOTAL_GPUS}_niter${NUM_ITERATIONS}_T5_CLAP_${MODEL}
WEIGHTS=/apdcephfs_gy4/share_302507476/xiquanli/TTA/MeanAudio/weights/fluxaudio_fm.pth
