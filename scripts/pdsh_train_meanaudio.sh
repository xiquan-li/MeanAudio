...
#### Model config
MODEL='meanaudio_m_full'
# MODEL='fluxaudio_m_full'
...
MINI_TRAIN=False
USE_MEANFLOW=True  # for runner config 
USE_WANDB=True  

EXP_ID=AWM_8kh_10s_bsz${BATCH_SIZE}_numgpus${TOTAL_GPUS}_niter${NUM_ITERATIONS}_T5_CLAP_${MODEL}
# EXP_ID=AC_10s_bsz${BATCH_SIZE}_numgpus${TOTAL_GPUS}_niter${NUM_ITERATIONS}_T5_CLAP_${MODEL}
WEIGHTS='/apdcephfs_gy4/share_302507476/xiquanli/exps/MeanAudio/AWM_8kh_10s_bsz4096_numgpus64_niter50_000_T5_CLAP_fluxaudio_m_full/AWM_8kh_10s_bsz4096_numgpus64_niter50_000_T5_CLAP_fluxaudio_m_full_ema_final.pth'
